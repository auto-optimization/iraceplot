...
```{r fig.align="center"}
parallel_cat(irace_results = iraceResults, iterations = c(2,5) )
```
...
```{r fig.align="center"}
 sampling_frequency(iraceResults, param_names = c("ants"))
```
...
```{r fig.align="center"}
sampling_frequency_iteration(iraceResults, parameter = "ants")
```
